...
- **`BITBUCKET_API_TOKEN`** — Secret text con un API token de Bitbucket (workspace `firmapro`), usado con el usuario `x-bitbucket-api-token-auth`. Usado por `resolveBitbucketCommit`.
