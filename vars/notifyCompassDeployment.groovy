...
def call(String componentId, String state, String environment, String startedAt, String completedAt) {
    try {
      ...
      if (environment.toLowerCase().contains("prod")) {
          ...
          envCategory = "STAGING"
      } else if (environment.toLowerCase().contains("pre")) {
          envCategory = "STAGING"
      }
